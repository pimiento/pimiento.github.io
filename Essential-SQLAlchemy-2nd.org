...
#+PROPERTY: header-args :eval never-export :exports both :noweb yes
...
#+NAME: E1
#+BEGIN_SRC python :session ch1 :results none :tangle ch1-v1.py :shebang "#!/usr/bin/env python3"
  <<A1>>
  <<B1>>
  <<C1>>
  <<D1>>
...
** SQLAlchemy v2
#+BEGIN_SRC python :results none :tangle ch1-v2.py :shebang "#!/usr/bin/env python3"
  #!/usr/bin/env python3
  from datetime import datetime
...
- Transient :: объект *не находится в сессии*, ровно как и *не находится в базе данных*
- Pending :: объект был *добавлен в сессию* методом /add()/, но ещё не был закоммичен
- Persistent :: объкт *в сессии* и *содержит соответствующую запись в базе*
- Detached :: объект *больше не в сессии*, но *содержит запись в базе данных*
** SQLAlchemy v1
:PROPERTIES:
:header-args:python: :session *ch8-v1* :tangle ch8-v1.py :cache yes :noweb yes
:END:
...
#+BEGIN_SRC python :results table
  ...
  [
      (state, getattr(insp, state))
      for state in ["transient", "pending", "persistent", "detached"]
  ]
#+END_SRC

#+RESULTS[5b92b5e6a2e5ebbe508787b0f819dcb13c3dac91]: inspect_state
| transient  | True  |
| pending    | False |
| persistent | False |
| detached   | False |
...
#+RESULTS[0378d1b2c44b7e1c975841f7ed5c2996a7549d8f]:
| transient  | False |
| pending    | True  |
| persistent | False |
| detached   | False |
...
#+RESULTS[7ee412ff6ac55f300185fc0b8c2253bba4975e13]:
| transient  | False |
| pending    | False |
| persistent | True  |
| detached   | False |
...
#+RESULTS[3b976cab1dcea5b45840e1343035aec8a9737cdc]:
| transient  | False |
| pending    | False |
| persistent | False |
| detached   | True  |
...
#+RESULTS[d5921158c04975974281520c2b1b2eb22ea396b4]:
: True
...
#+RESULTS[6e8df47d932c957791f332b1e631530a757fbbff]:
...
#+BEGIN_SRC python :results output
  ...
  try:
      ...
      logging.exception("более одной записи в таблице Cookie")
#+END_SRC

#+RESULTS[dca1360ecf2861d3a9f15154a7cfcb97d2ebf854]:
#+begin_example
ERROR:root:более одной записи в таблице Cookie
Traceback (most recent call last):
  File "/tmp/babel-0NE78C/python-ZcRDHC", line 14, in <module>
    results = session.query(Cookie).one()
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/query.py", line 2815, in one
    return self._iter().one()  # type: ignore
           ~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/engine/result.py", line 1867, in one
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/engine/result.py", line 852, in _only_one_row
...
#+BEGIN_SRC python :results output
  try:
      session.query(Order).one()
  except sqlalchemy.exc.NoResultFound:
      logging.exception("нет записей в таблице Order")
#+END_SRC

#+RESULTS:
#+begin_example
ERROR:root:нет записей в таблице Order
Traceback (most recent call last):
  File "/tmp/babel-0NE78C/python-gFJXyQ", line 2, in <module>
    session.query(Order).one()
    ~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/query.py", line 2815, in one
    return self._iter().one()  # type: ignore
  ...
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/engine/result.py", line 1867, in one
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/engine/result.py", line 799, in _only_one_row
...
#+BEGIN_SRC python :results output
  ...
  try:
      ...
      logging.exception("order уже отвязан от сессии, нельзя получить его relationship")
#+END_SRC

#+RESULTS:
#+begin_example
ERROR:root:order уже отвязан от сессии, нельзя получить его relationship
Traceback (most recent call last):
  File "/tmp/babel-0NE78C/python-K8DLx5", line 22, in <module>
    order.line_items
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/attributes.py", line 569, in __get__
    return self.impl.get(state, dict_)  # type: ignore[no-any-return]
           ~~~~~~~~~~~~~^^^^^^^^^^^^^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/attributes.py", line 1096, in get
    value = self._fire_loader_callables(state, key, passive)
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/attributes.py", line 1131, in _fire_loader_callables
    return self.callable_(state, passive)
           ~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/strategies.py", line 929, in _load_for_state
    raise orm_exc.DetachedInstanceError(
    ...<3 lines>...
    )
sqlalchemy.orm.exc.DetachedInstanceError: Parent instance <Order at 0x7f47bd840c20> is not bound to a Session; lazy load operation of attribute 'line_items' cannot proceed (Background on this error at: https://sqlalche.me/e/20/bhk3)
#+end_example
*** Transactions
:PROPERTIES:
:header-args:python: :session *ch8-tr-v1* :tangle ch8-tr-v1.py :cache yes :noweb yes
:END:
#+BEGIN_SRC python :results none :shebang "#!/usr/bin/env python3"
  ...
  class LineItem(Base):
      ...
      def __repr__(self):
          return (
              "LineItem(order_id={self.order_id}, "
  ...
  def ship_it(order_id: str) -> None:
      """
      принимает order_id, удаляет cookies из доступного числа,
      помечает заказ как shipped
      """
...
#+BEGIN_SRC python :results output
  ...
  try:
      ...
      logging.exception("order_id: 2")
#+END_SRC

#+RESULTS:
#+begin_example
ERROR:root:order_id: 2
Traceback (most recent call last):
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/engine/base.py", line 1969, in _exec_single_context
    self.dialect.do_execute(
    ~~~~~~~~~~~~~~~~~~~~~~~^
...
Traceback (most recent call last):
  File "/tmp/babel-0NE78C/python-y32EFG", line 4, in <module>
    ship_it(2)
    ~~~~~~~^^^
  File "<string>", line 156, in ship_it
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2035, in commit
    trans.commit(_to_root=True)
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^
  File "<string>", line 2, in commit
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/state_changes.py", line 137, in _go
    ret_value = fn(self, *arg, **kw)
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 1316, in commit
    self._prepare_impl()
    ~~~~~~~~~~~~~~~~~~^^
  File "<string>", line 2, in _prepare_impl
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/state_changes.py", line 137, in _go
    ret_value = fn(self, *arg, **kw)
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 1290, in _prepare_impl
    self.session.flush()
    ~~~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 4353, in flush
    self._flush(objects)
    ~~~~~~~~~~~^^^^^^^^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 4488, in _flush
    with util.safe_reraise():
         ~~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/util/langhelpers.py", line 122, in __exit__
    raise exc_value.with_traceback(exc_tb)
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 4449, in _flush
    flush_context.execute()
    ~~~~~~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/unitofwork.py", line 465, in execute
    rec.execute(self)
    ~~~~~~~~~~~^^^^^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/unitofwork.py", line 641, in execute
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/persistence.py", line 86, in save_obj
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/persistence.py", line 913, in _emit_update_statements
...
#+BEGIN_SRC python :results output
  try:
      ...
      logging.exception("нужен rollback")
#+END_SRC

#+RESULTS:
#+begin_example
ERROR:root:нужен rollback
Traceback (most recent call last):
  File "/tmp/babel-0NE78C/python-aSjO6i", line 2, in <module>
    print(session.query(Cookie.cookie_name, Cookie.quantity).all())
          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/query.py", line 2711, in all
    return self._iter().all()  # type: ignore
           ~~~~~~~~~~^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/query.py", line 2864, in _iter
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2373, in execute
    ...
    ^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2261, in _execute_internal
    conn = self._connection_for_bind(bind)
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2113, in _connection_for_bind
    return trans._connection_for_bind(engine, execution_options)
           ~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "<string>", line 2, in _connection_for_bind
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/state_changes.py", line 101, in _go
    self._raise_for_prerequisite_state(fn.__name__, current_state)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 975, in _raise_for_prerequisite_state
    raise sa_exc.PendingRollbackError(
    ...<6 lines>...
    )
sqlalchemy.exc.PendingRollbackError: This Session's transaction has been rolled back due to a previous exception during flush. To begin a new transaction with this Session, first issue Session.rollback(). Original exception was: (sqlite3.IntegrityError) CHECK constraint failed: quantity_positive
[SQL: UPDATE cookies SET quantity=? WHERE cookies.cookie_id = ?]
[parameters: (-8, 2)]
...
#+BEGIN_SRC python :results output
  def trans_ship_it (order_id:str) -> None:
      """ship_it с поддержкой отката транзакции"""
      order = session.query(Order).get(order_id)
      for li in order.line_items:
          li.cookie.quantity = li.cookie.quantity - li.quantity
          session.add(li.cookie)
...
#+RESULTS:
: ERROR:root:CHECK constraint failed: quantity_positive
: [('chocolate chip', 3), ('dark chocolate chip', 1)]
...
*** Transactions
:PROPERTIES:
:header-args:python: :session *ch8-tr-v2* :tangle ch8-tr-v2.py :cache yes
:END:
#+BEGIN_SRC python :results output :shebang "#!/usr/bin/env python3"
  #!/usr/bin/env python3
  import logging
  ...
  class User(Base):
      ...
      def __init__(
          self, username: str, email_address: str, phone: str, password: str
      ) -> None:
          self.username = username
          self.email_address = email_address
          self.phone = phone
  ...
  class LineItem(Base):
      ...
      extended_cost: Mapped[Decimal] = mapped_column(Numeric(12, 2))
      ...
      def __repr__(self) -> str:
          return (
              f"LineItem(order_id={self.order_id}, "
  ...
  stmt = select(Cookie.cookie_name, Cookie.quantity)
  print(session.execute(stmt).all())
  ...
  def trans_ship_it(order_id: int) -> None:
      try:
          with session.nested_begin():
              order = session.get(Order, order_id)
              if order is None:
                  raise ValueError(f"Order {order_id} not found")
              for li in order.line_items:
                  assert li.cookie is not None
                  li.cookie.quantity -= li.quantity
              order.shipped = True
          print(f"shipped order ID: {order_id}")
      except sa.exc.IntegrityError as error:
          logging.error(error.orig)
...
#+RESULTS[a47407ad9a3195076bce967c19c880f1bb5d3ce9]:
#+begin_example
  shipped order ID: 1
  [('chocolate chip', 3), ('dark chocolate chip', 1)]
  ERROR:root:order_id: 2
  ...
  Traceback (most recent call last):
    File "/tmp/babel-0NE78C/python-VGomxl", line 201, in <module>
      ship_it(2)
      ~~~~~~~^^^
    File "/tmp/babel-0NE78C/python-VGomxl", line 191, in ship_it
      session.commit()
      ~~~~~~~~~~~~~~^^
    File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2035, in commit
      trans.commit(_to_root=True)
  ...
  ERROR:root:нужен rollback
  Traceback (most recent call last):
    File "/tmp/babel-0NE78C/python-VGomxl", line 206, in <module>
      print(session.execute(stmt).all())
            ~~~~~~~~~~~~~~~^^^^^^
    File "/home/octopus/study/Python/sqlalchemy-study/.venv/lib/python3.14/site-packages/sqlalchemy/orm/session.py", line 2373, in execute
      return self._execute_internal(
